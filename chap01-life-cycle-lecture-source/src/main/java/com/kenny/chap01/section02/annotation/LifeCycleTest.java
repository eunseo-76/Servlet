package com.kenny.chap01.section02.annotation;
...
* 전달하는 숫자는 우선 순위로 숫자가 낮을수록 우선순위가 높다. */
@WebServlet(value = "/annotation-lifecycle", loadOnStartup = 1) // webservlet 어노테이션 = 클래스가 servlet으로 등록되었다는 의미
